const pageConfig = {
  ...
  title: "nirvana66's Status Page",
  // Links shown at the header of your status page, could set `highlight` to `true`
  links: [
    { link: 'https://github.com/nirvana66', label: 'GitHub' },
    { link: 'https://blog.nirvana66.site/', label: 'Blog' },
    { link: 'mailto:me@nirvana66.site', label: 'Email Me', highlight: true },
  ],
}
